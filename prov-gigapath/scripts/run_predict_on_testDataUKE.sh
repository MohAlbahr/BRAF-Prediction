...
## for prediction on UKE dataset (The resulted Predictions are used for AUC calculation using Prov-gigaPath alone (see manuscript))
DATASETCSV=dataset_csv/braf/tiles_tcga_uke_embeddings_with_labels.csv
PRESPLITDIR=dataset_csv/braf/train_all_TCGA_test_UKE   # test_0 contains here the whole UKE dataset file names
...
# Fine-tuning
python finetune/predict_on_testDataUKE.py \
