...
#   script (for generating the slide. Represent. of test-subsets of Cross-Valition of TCGA).
#
# ==============================================================================
...
DATASETCSV=prov-gigapath/dataset_csv/braf/tiles_embeddings_with_labels.csv
PRESPLITDIR=prov-gigapath/dataset_csv/braf/braf_5_folds/braf
...
# Output settings
WORKSPACE=prov-gigapath/outputs/braf/slide_representations
SAVEDIR=$WORKSPACE
...
python prov-gigapath/finetune/generate_slide_representations.py \
