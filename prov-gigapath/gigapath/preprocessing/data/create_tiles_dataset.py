...
if __name__ == '__main__':
    ...
    slides_dataset= None # Must be called correctly 
    main(slides_dataset, "path/to/output", level=0, tile_size=512, margin=128,
         foreground_threshold=None, occupancy_threshold=0.5, parallel=False, overwrite=False)
# %%    